...
module video_regs(
	...
	assign #T_TRI  mufe = !vycu ? !(!myce) : 1'bz;
	assign #T_TRI  lova = !vycu ? !(!mypa) : 1'bz;
	assign #T_TRI  muka = !vycu ? !(!nofe) : 1'bz;
	assign #T_TRI  mara = !vycu ? !(!nuku) : 1'bz;
	assign #T_TRI  mele = !vycu ? !(!mypu) : 1'bz;
	assign #T_TRI  muly = !vycu ? !(!muvo) : 1'bz;
	assign #T_TRI  lole = !vycu ? !(!meby) : 1'bz;
	assign #T_TRI  moko = !vycu ? !(!noke) : 1'bz;
	assign ff4b_d5 = myce;
	assign ff4b_d0 = mypa;
	assign ff4b_d1 = nofe;
	assign ff4b_d7 = nuku;
	...
	assign #T_TRI  mera = !vomy ? !(!nafu) : 1'bz;
	assign #T_TRI  loka = !vomy ? !(!mela) : 1'bz;
	assign #T_TRI  poda = !vomy ? !(!nyro) : 1'bz;
	assign #T_TRI  pygu = !vomy ? !(!naga) : 1'bz;
	assign #T_TRI  mega = !vomy ? !(!nulo) : 1'bz;
	assign #T_TRI  polo = !vomy ? !(!nuka) : 1'bz;
	assign #T_TRI  pela = !vomy ? !(!nene) : 1'bz;
	assign #T_TRI  punu = !vomy ? !(!neso) : 1'bz;
	assign ff4a_d7 = nafu;
	assign ff4a_d3 = mela;
	assign ff4a_d1 = nyro;
	assign ff4a_d2 = naga;
	...
	assign #T_TRI  cuga = !beba ? !(!cyxu) : 1'bz;
	assign #T_TRI  casy = !beba ? !(!bake) : 1'bz;
	assign #T_TRI  cedu = !beba ? !(!bemy) : 1'bz;
	assign #T_TRI  cata = !beba ? !(!cuzy) : 1'bz;
	assign #T_TRI  doxe = !beba ? !(!cabu) : 1'bz;
	assign #T_TRI  ekob = !beba ? !(!duzu) : 1'bz;
	assign #T_TRI  edos = !beba ? !(!daty) : 1'bz;
	assign #T_TRI  wony = !beba ? !(!gubo) : 1'bz;
	assign ff43_d2 = cyxu;
	assign ff43_d7 = bake;
	assign ff43_d4 = bemy;
	assign ff43_d5 = cuzy;
	...
	assign #T_TRI  gonu = !buwy ? !(!fezu) : 1'bz;
	assign #T_TRI  gyza = !buwy ? !(!funy) : 1'bz;
	assign #T_TRI  cusa = !buwy ? !(!dede) : 1'bz;
	assign #T_TRI  gyzo = !buwy ? !(!foty) : 1'bz;
	assign #T_TRI  gune = !buwy ? !(!foha) : 1'bz;
	assign #T_TRI  goba = !buwy ? !(!fymo) : 1'bz;
	assign #T_TRI  ware = !buwy ? !(!gave) : 1'bz;
	assign #T_TRI  godo = !buwy ? !(!fujo) : 1'bz;
	assign ff42_d2 = fezu;
	assign ff42_d7 = funy;
	assign ff42_d4 = dede;
	assign ff42_d5 = foty;
	...
	assign #T_TRI  xero = !wyce ? !(!xylo) : 1'bz;
	assign #T_TRI  wuka = !wyce ? !(!xafo) : 1'bz;
	assign #T_TRI  wyju = !wyce ? !(!xymo) : 1'bz;
	assign #T_TRI  xebu = !wyce ? !(!xona) : 1'bz;
	assign #T_TRI  vato = !wyce ? !(!wymo) : 1'bz;
	assign #T_TRI  voke = !wyce ? !(!wexu) : 1'bz;
	assign #T_TRI  vaha = !wyce ? !(!woky) : 1'bz;
	assign #T_TRI  wypo = !wyce ? !(!vyxe) : 1'bz;
	assign ff40_d1 = xylo;
	assign ff40_d3 = xafo;
	assign ff40_d2 = xymo;
	assign ff40_d7 = xona;
	...
	assign #T_TRI  race = !weku ? !(!sota) : 1'bz;
	assign #T_TRI  retu = !weku ? !(!syry) : 1'bz;
	assign #T_TRI  redy = !weku ? !(!salo) : 1'bz;
	assign #T_TRI  razu = !weku ? !(!sedy) : 1'bz;
	assign #T_TRI  vafe = !weku ? !(!vevo) : 1'bz;
	assign #T_TRI  vazu = !weku ? !(!vafa) : 1'bz;
	assign #T_TRI  vojo = !weku ? !(!vuce) : 1'bz;
	assign #T_TRI  pufy = !weku ? !(!raha) : 1'bz;
	assign ff45_d4 = sota;
	assign ff45_d0 = syry;
	assign ff45_d3 = salo;
	assign ff45_d2 = sedy;
	...
	assign #T_TRI  vyne = !varo ? !wata : 1'bz;
	assign #T_TRI  wama = !varo ? !xaga : 1'bz;
	assign #T_TRI  wuva = !varo ? !xepo : 1'bz;
	assign #T_TRI  wojy = !varo ? !xuhy : 1'bz;
	assign #T_TRI  weze = !varo ? !xowo : 1'bz;
	assign #T_TRI  wavo = !varo ? !xuce : 1'bz;
	assign #T_TRI  vega = !varo ? !wury : 1'bz;
	assign #T_TRI  lyco = !varo ? !myfa : 1'bz;
	assign d[4] = vyne;
	assign d[5] = wama;
	assign d[1] = wuva;
	assign d[3] = wojy;
