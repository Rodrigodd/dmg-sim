...
module palettes(
	...
	assign #T_TRI  lary = ~tepy ? ~(~mena) : 1'bz;
	assign #T_TRI  lyka = ~tepy ? ~(~moru) : 1'bz;
	assign #T_TRI  lobe = ~tepy ? ~(~maxy) : 1'bz;
	assign #T_TRI  paba = ~tepy ? ~(~nusy) : 1'bz;
	assign #T_TRI  lody = ~tepy ? ~(~mogy) : 1'bz;
	assign #T_TRI  lace = ~tepy ? ~(~muke) : 1'bz;
	assign #T_TRI  redo = ~tepy ? ~(~pylu) : 1'bz;
	assign #T_TRI  raro = ~tepy ? ~(~pavo) : 1'bz;
	assign bgp_d[7] = mena;
	assign bgp_d[5] = moru;
	assign bgp_d[3] = maxy;
	assign bgp_d[1] = nusy;
	...
	assign #T_TRI  xawo = ~xozy ? ~(~xana) : 1'bz;
	assign #T_TRI  xobo = ~xozy ? ~(~xyze) : 1'bz;
	assign #T_TRI  xuby = ~xozy ? ~(~xalo) : 1'bz;
	assign #T_TRI  xoke = ~xozy ? ~(~xuky) : 1'bz;
	assign #T_TRI  xaxa = ~xozy ? ~(~xupo) : 1'bz;
	assign #T_TRI  xaju = ~xozy ? ~(~xeru) : 1'bz;
	assign #T_TRI  xuno = ~xozy ? ~(~xova) : 1'bz;
	assign #T_TRI  xary = ~xozy ? ~(~xufu) : 1'bz;
	...
	assign #T_TRI  lelu = ~lote ? ~(~luxo) : 1'bz;
	assign #T_TRI  luga = ~lote ? ~(~lugu) : 1'bz;
	assign #T_TRI  lyza = ~lote ? ~(~lose) : 1'bz;
	assign #T_TRI  lepa = ~lote ? ~(~lawo) : 1'bz;
	assign #T_TRI  leba = ~lote ? ~(~lepu) : 1'bz;
	assign #T_TRI  luky = ~lote ? ~(~lune) : 1'bz;
	assign #T_TRI  lode = ~lote ? ~(~mosa) : 1'bz;
	assign #T_TRI  laju = ~lote ? ~(~moxy) : 1'bz;
