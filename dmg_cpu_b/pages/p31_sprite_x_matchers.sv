...
module sprite_x_matchers(
	...
	assign #T_TRIB xaca = ~oam_a_cpu_nrd ? ~xyky : 1'bz;
	assign #T_TRIB xagu = ~oam_a_cpu_nrd ? ~yrum : 1'bz;
	assign #T_TRIB xepu = ~oam_a_cpu_nrd ? ~ysex : 1'bz;
	assign #T_TRIB xygu = ~oam_a_cpu_nrd ? ~yvel : 1'bz;
	assign #T_TRIB xuna = ~oam_a_cpu_nrd ? ~wyno : 1'bz;
	assign #T_TRIB deve = ~oam_a_cpu_nrd ? ~cyra : 1'bz;
	assign #T_TRIB zeha = ~oam_a_cpu_nrd ? ~zuve : 1'bz;
	assign #T_TRIB fyra = ~oam_a_cpu_nrd ? ~eced : 1'bz;
