...
module sprite_store(
	...
	assign #T_TRI  weza_o = ~buza ? ~(~xecu) : 1'bz;
	assign #T_TRI  wuco_o = ~buza ? ~(~yduf) : 1'bz;
	assign #T_TRI  wyda_o = ~buza ? ~(~xobe) : 1'bz;
	assign #T_TRI  zysu_o = ~buza ? ~(~zuze) : 1'bz;
	assign #T_TRI  wyse_o = ~buza ? ~(~xedy) : 1'bz;
	assign #T_TRI  wuzy_o = ~buza ? ~(~xadu) : 1'bz;
	assign #T_TRI  wenu_o = ~fepo ? ~gysa : 1'bz;
	assign #T_TRI  cucu_o = ~fepo ? ~dege : 1'bz;
	assign #T_TRI  cega_o = ~fepo ? ~dabu : 1'bz;
	assign #T_TRI  cuca_o = ~fepo ? ~daby : 1'bz;
	assign #T_TRI  adyb = ~deny ? ~(~axuv) : 1'bz;
	assign #T_TRI  apob = ~deny ? ~(~bada) : 1'bz;
	assign #T_TRI  apyv = ~deny ? ~(~apev) : 1'bz;
	assign #T_TRI  afen = ~deny ? ~(~bado) : 1'bz;
	assign #T_TRI  akyh = ~deny ? ~(~bexy) : 1'bz;
	assign #T_TRI  apoc = ~deny ? ~(~byhe) : 1'bz;
	assign #T_TRI  bujy = ~deny ? ~(~afym) : 1'bz;
	assign #T_TRI  boso = ~deny ? ~(~azap) : 1'bz;
	assign #T_TRI  ahac = ~deny ? ~(~afut) : 1'bz;
	assign #T_TRI  bazu = ~deny ? ~(~afyx) : 1'bz;
	assign #T_TRI  wocy = ~xyme ? ~(~gecu) : 1'bz;
	assign #T_TRI  elyc = ~xyme ? ~(~foxy) : 1'bz;
	assign #T_TRI  wabo = ~xyme ? ~(~gohu) : 1'bz;
	assign #T_TRI  ezoc = ~xyme ? ~(~fogo) : 1'bz;
	assign #T_TRI  wywy = ~xyme ? ~(~gacy) : 1'bz;
	assign #T_TRI  wato = ~xyme ? ~(~gabo) : 1'bz;
	assign #T_TRI  zudo = ~xyme ? ~(~zube) : 1'bz;
	assign #T_TRI  ybuk = ~xyme ? ~(~zumy) : 1'bz;
	assign #T_TRI  zyto = ~xyme ? ~(~zexo) : 1'bz;
	assign #T_TRI  ykoz = ~xyme ? ~(~zafu) : 1'bz;
	assign #T_TRI  waja = ~gowo ? ~(~xynu) : 1'bz;
	assign #T_TRI  woxy = ~gowo ? ~(~xege) : 1'bz;
	assign #T_TRI  xyre = ~gowo ? ~(~xabo) : 1'bz;
	assign #T_TRI  weru = ~gowo ? ~(~wanu) : 1'bz;
	assign #T_TRI  wepy = ~gowo ? ~(~xefe) : 1'bz;
	assign #T_TRI  wuxu = ~gowo ? ~(~xave) : 1'bz;
	assign #T_TRI  bydo = ~gowo ? ~(~cumu) : 1'bz;
	assign #T_TRI  buce = ~gowo ? ~(~capo) : 1'bz;
	assign #T_TRI  bove = ~gowo ? ~(~cono) : 1'bz;
	assign #T_TRI  bevy = ~gowo ? ~(~caju) : 1'bz;
	assign #T_TRI  evyt = ~gugy ? ~(~fuzo) : 1'bz;
	assign #T_TRI  waba = ~gugy ? ~(~gesy) : 1'bz;
	assign #T_TRI  etad = ~gugy ? ~(~fysu) : 1'bz;
	assign #T_TRI  elep = ~gugy ? ~(~fefa) : 1'bz;
	assign #T_TRI  wygo = ~gugy ? ~(~gyno) : 1'bz;
	assign #T_TRI  wako = ~gugy ? ~(~gule) : 1'bz;
	assign #T_TRI  wana = ~gugy ? ~(~xygo) : 1'bz;
	assign #T_TRI  waxe = ~gugy ? ~(~xyna) : 1'bz;
	assign #T_TRI  wabu = ~gugy ? ~(~xaku) : 1'bz;
	assign #T_TRI  ypoz = ~gugy ? ~(~ygum) : 1'bz;
	assign #T_TRI  bemo = ~dydo ? ~(~cajy) : 1'bz;
	assign #T_TRI  cyby = ~dydo ? ~(~cuza) : 1'bz;
	assign #T_TRI  bety = ~dydo ? ~(~coma) : 1'bz;
	assign #T_TRI  cegy = ~dydo ? ~(~cufa) : 1'bz;
	assign #T_TRI  celu = ~dydo ? ~(~cebo) : 1'bz;
	assign #T_TRI  cubo = ~dydo ? ~(~cadu) : 1'bz;
	assign #T_TRI  befe = ~dydo ? ~(~abug) : 1'bz;
	assign #T_TRI  byro = ~dydo ? ~(~ames) : 1'bz;
	assign #T_TRI  baco = ~dydo ? ~(~abop) : 1'bz;
	assign #T_TRI  ahum = ~dydo ? ~(~arof) : 1'bz;
	assign #T_TRI  dalo = ~gygy ? ~(~ekap) : 1'bz;
	assign #T_TRI  daly = ~gygy ? ~(~etav) : 1'bz;
	assign #T_TRI  duza = ~gygy ? ~(~ebex) : 1'bz;
	assign #T_TRI  waga = ~gygy ? ~(~goru) : 1'bz;
	assign #T_TRI  dyny = ~gygy ? ~(~etym) : 1'bz;
	assign #T_TRI  dobo = ~gygy ? ~(~ekop) : 1'bz;
	assign #T_TRI  awat = ~gygy ? ~(~aned) : 1'bz;
	assign #T_TRI  bace = ~gygy ? ~(~acep) : 1'bz;
	assign #T_TRI  bodu = ~gygy ? ~(~abux) : 1'bz;
	assign #T_TRI  buja = ~gygy ? ~(~abeg) : 1'bz;
	assign #T_TRI  dezu = ~gyma ? ~(~dafu) : 1'bz;
	assign #T_TRI  efud = ~gyma ? ~(~deba) : 1'bz;
	assign #T_TRI  dony = ~gyma ? ~(~duha) : 1'bz;
	assign #T_TRI  dowa = ~gyma ? ~(~duny) : 1'bz;
	assign #T_TRI  dygo = ~gyma ? ~(~dese) : 1'bz;
	assign #T_TRI  enap = ~gyma ? ~(~devy) : 1'bz;
	assign #T_TRI  zypo = ~gyma ? ~(~zury) : 1'bz;
	assign #T_TRI  zexe = ~gyma ? ~(~zuro) : 1'bz;
	assign #T_TRI  yjem = ~gyma ? ~(~zene) : 1'bz;
	assign #T_TRI  ywav = ~gyma ? ~(~zylu) : 1'bz;
	assign #T_TRI  axec = ~fame ? ~(~boxa) : 1'bz;
	assign #T_TRI  cyro = ~fame ? ~(~buna) : 1'bz;
	assign #T_TRI  cuvu = ~fame ? ~(~bulu) : 1'bz;
	assign #T_TRI  apon = ~fame ? ~(~beca) : 1'bz;
	assign #T_TRI  afoz = ~fame ? ~(~byhu) : 1'bz;
	assign #T_TRI  cube = ~fame ? ~(~buhe) : 1'bz;
	assign #T_TRI  zaby = ~fame ? ~(~ykuk) : 1'bz;
	assign #T_TRI  zuke = ~fame ? ~(~ylov) : 1'bz;
	assign #T_TRI  wuxe = ~fame ? ~(~xazy) : 1'bz;
	assign #T_TRI  were = ~fame ? ~(~xosy) : 1'bz;
	assign #T_TRI  yhal = ~fado ? ~(~xufo) : 1'bz;
	assign #T_TRI  yrad = ~fado ? ~(~xute) : 1'bz;
	assign #T_TRI  xyra = ~fado ? ~(~xotu) : 1'bz;
	assign #T_TRI  ynev = ~fado ? ~(~xyfe) : 1'bz;
	assign #T_TRI  zojy = ~fado ? ~(~yzor) : 1'bz;
	assign #T_TRI  zaro = ~fado ? ~(~yber) : 1'bz;
	assign #T_TRI  cawo = ~fado ? ~(~dewu) : 1'bz;
	assign #T_TRI  byme = ~fado ? ~(~cana) : 1'bz;
	assign #T_TRI  coho = ~fado ? ~(~dysy) : 1'bz;
	assign #T_TRI  gate = ~fado ? ~(~fofo) : 1'bz;
	assign #T_TRI  zetu = ~furo ? ~(~ygus) : 1'bz;
	assign #T_TRI  zece = ~furo ? ~(~ysok) : 1'bz;
	assign #T_TRI  zave = ~furo ? ~(~yzep) : 1'bz;
	assign #T_TRI  woko = ~furo ? ~(~wyte) : 1'bz;
	assign #T_TRI  zumu = ~furo ? ~(~zony) : 1'bz;
	assign #T_TRI  zedy = ~furo ? ~(~ywak) : 1'bz;
	assign #T_TRI  gofo = ~furo ? ~(~fyhy) : 1'bz;
	assign #T_TRI  wehe = ~furo ? ~(~gyho) : 1'bz;
	assign #T_TRI  ajal = ~furo ? ~(~bozu) : 1'bz;
	assign #T_TRI  buky = ~furo ? ~(~cufo) : 1'bz;
