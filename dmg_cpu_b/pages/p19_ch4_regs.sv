...
module ch4_regs(
	...
	assign #T_TRI  hacu = ~hasu ? ~(~gedu) : 1'bz;
	assign #T_TRI  hoge = ~hasu ? ~(~gozo) : 1'bz;
	assign #T_TRI  godu = ~hasu ? ~(~goky) : 1'bz;
	assign #T_TRI  heda = ~hasu ? ~(~garu) : 1'bz;
	assign #T_TRI  gome = ~hasu ? ~(~geky) : 1'bz;
	assign #T_TRI  cuzu = ~boxe ? ~(~ezyk) : 1'bz;
	assign #T_TRI  coce = ~boxe ? ~(~etyj) : 1'bz;
	assign #T_TRI  demy = ~boxe ? ~(~emok) : 1'bz;
	assign ff21_d7  = gedu;
	assign ff21_d6  = gozo;
	assign ff21_d5  = goky;
	assign ff21_d4  = garu;
	...
	assign #T_TRI  keta = ~jora ? ~(~jamy) : 1'bz;
	assign #T_TRI  geda = ~heze ? ~(~feta) : 1'bz;
	assign #T_TRI  gaka = ~heze ? ~(~gogo) : 1'bz;
	assign #T_TRI  hapy = ~heze ? ~(~gafo) : 1'bz;
	assign #T_TRI  gype = ~heze ? ~(~fyto) : 1'bz;
	assign ff22_d3  = jamy;
	...
	assign #T_TRI  kyro = ~keka ? ~(~jaky) : 1'bz;
	assign #T_TRI  kaku = ~keka ? ~(~jero) : 1'bz;
	assign #T_TRI  kamo = ~keka ? ~(~jare) : 1'bz;
	...
	assign #T_TRI  cury = ~bare ? ~(~cuny) : 1'bz;
	assign ff23_d6  = cuny;
