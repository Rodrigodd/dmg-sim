...
module vram_interface(
	...
	assign #T_TRIB tahy = !runy ? sole : 1'bz;
	assign #T_TRIB tesu = !runy ? sole : 1'bz;
	assign #T_TRIB taxo = !runy ? sole : 1'bz;
	assign #T_TRIB tovu = !runy ? sole : 1'bz;
	assign #T_TRIB tazu = !runy ? sole : 1'bz;
	assign #T_TRIB tewa = !runy ? sole : 1'bz;
	assign #T_TRIB sosa = !runy ? sole : 1'bz;
	assign #T_TRIB sedu = !runy ? sole : 1'bz;
	assign d[4] = tahy;
	assign d[5] = tesu;
	assign d[3] = taxo;
	assign d[0] = tovu;
	...
	assign #T_TRIB ropa = !lyra ? ryba : 1'bz;
	assign #T_TRIB sywa = !lyra ? ruzy : 1'bz;
	assign #T_TRIB sugu = !lyra ? rome : 1'bz;
	assign #T_TRIB tute = !lyra ? tehe : 1'bz;
	assign #T_TRIB temy = !lyra ? soca : 1'bz;
	assign #T_TRIB sajo = !lyra ? ratu : 1'bz;
	assign #T_TRIB tuty = !lyra ? tovo : 1'bz;
	assign #T_TRIB tawo = !lyra ? saza : 1'bz;
	assign d[7] = ropa;
	assign d[1] = sywa;
	assign d[2] = sugu;
	assign d[4] = tute;
	...
	assign #T_TRIB teme = !rahu ? d[0] : 1'bz;
	assign #T_TRIB tewu = !rahu ? d[1] : 1'bz;
	assign #T_TRIB tygo = !rahu ? d[2] : 1'bz;
	assign #T_TRIB sote = !rahu ? d[3] : 1'bz;
	assign #T_TRIB seke = !rahu ? d[4] : 1'bz;
	assign #T_TRIB rujo = !rahu ? d[5] : 1'bz;
	assign #T_TRIB tofa = !rahu ? d[6] : 1'bz;
	assign #T_TRIB suza = !rahu ? d[7] : 1'bz;
	...
	assign #T_TRI  tobo = neta ? !pyju : 1'bz;
	assign #T_TRI  suvo = neta ? !powy : 1'bz;
	assign #T_TRI  reso = neta ? !poju : 1'bz;
	assign #T_TRI  roha = neta ? !pulo : 1'bz;
	assign #T_TRI  rusa = neta ? !poxa : 1'bz;
	assign #T_TRI  vejy = neta ? !pyzo : 1'bz;
	assign #T_TRI  sezu = neta ? !pozo : 1'bz;
	assign #T_TRI  vapy = neta ? !rawu : 1'bz;
	assign nma[12] = vury;
	assign nma[11] = tobo;
	assign nma[10] = suvo;
	assign nma[9]  = reso;
