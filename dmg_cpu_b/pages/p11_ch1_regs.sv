...
module ch1_regs(
	...
	assign #T_TRI  jyse = !hocu ? !(!jopu) : 1'bz;
	assign #T_TRI  heve = !hocu ? !(!jena) : 1'bz;
	assign #T_TRI  hewa = !hocu ? !(!jaxo) : 1'bz;
	assign #T_TRI  howu = !hocu ? !(!jaty) : 1'bz;
	assign #T_TRI  hono = !hocu ? !(!jafy) : 1'bz;
	assign #T_TRI  jyne = !hamy ? !(!jusa) : 1'bz;
	assign #T_TRI  jaca = !hamy ? !(!juzy) : 1'bz;
	assign #T_TRI  joku = !hamy ? !(!joma) : 1'bz;
	assign ff12_d7  = jopu;
	assign ff12_d6  = jena;
	assign ff12_d5  = jaxo;
	assign ff12_d4  = jaty;
	...
	assign #T_TRI  bytu = !bale ? !(!boko) : 1'bz;
	assign ff14_d6  = boko;
	...
	assign #T_TRI  foru = !evaj ? !(!gaxe) : 1'bz;
	assign #T_TRI  gefu = !evaj ? !(!hyfe) : 1'bz;
	assign #T_TRI  kyvu = !evaj ? !(!jyty) : 1'bz;
	assign #T_TRI  kumo = !evaj ? !(!kyna) : 1'bz;
	assign #T_TRI  kary = !evaj ? !(!jema) : 1'bz;
	assign #T_TRI  gode = !evaj ? !(!hyke) : 1'bz;
	assign #T_TRI  goje = !evaj ? !(!feva) : 1'bz;
	assign #T_TRI  foze = !evaj ? !(!ekov) : 1'bz;
	assign #T_TRI  dopa = !dupy ? !(!emus) : 1'bz;
	assign #T_TRI  demu = !dupy ? !(!evak) : 1'bz;
	assign #T_TRI  dexo = !dupy ? !(!copu) : 1'bz;
	assign d[0] = foru;
	assign d[1] = gefu;
	assign d[2] = kyvu;
	assign d[3] = kumo;
	...
	assign #T_TRI  amyd = !asop ? !(!bany) : 1'bz;
	assign #T_TRI  azyp = !asop ? !(!anaz) : 1'bz;
	assign #T_TRI  awos = !asop ? !(!botu) : 1'bz;
	assign #T_TRI  afox = !asop ? !(!avaf) : 1'bz;
	assign #T_TRI  atax = !asop ? !(!arax) : 1'bz;
	assign #T_TRI  avek = !asop ? !(!adek) : 1'bz;
	assign #T_TRI  akux = !asop ? !(!bana) : 1'bz;
	...
	assign #T_TRI  bowo = !bexu ? !(!cena) : 1'bz;
	assign #T_TRI  cuda = !bexu ? !(!dyca) : 1'bz;
	assign ff11_d6  = cena;
