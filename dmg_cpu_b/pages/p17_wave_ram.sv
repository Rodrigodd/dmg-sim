...
module wave_ram(
	...
	assign #T_TRI  bezu = wave_ram_rd ? !akaf : 1'bz;
	assign #T_TRI  desa = wave_ram_rd ? !cuto : 1'bz;
	assign #T_TRI  bava = wave_ram_rd ? !bero : 1'bz;
	assign #T_TRI  bune = wave_ram_rd ? !baca : 1'bz;
	assign #T_TRI  bade = wave_ram_rd ? !adok : 1'bz;
	assign #T_TRI  baty = wave_ram_rd ? !atec : 1'bz;
	assign #T_TRI  desy = wave_ram_rd ? !cegu : 1'bz;
	assign #T_TRI  dugu = wave_ram_rd ? !cugo : 1'bz;
