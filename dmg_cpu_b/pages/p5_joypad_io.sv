...
module joypad_io(
	...
	assign #T_TRI  koce = ~byzo ? ~(~kely) : 1'bz;
	assign #T_TRI  cudy = ~byzo ? ~(~cofy) : 1'bz;
	...
	assign #T_TRI  anoc = ~afop ? ~1'd0 : 1'bz;
	assign #T_TRI  ajec = ~afop ? ~1'd0 : 1'bz;
	assign #T_TRI  arar = ~afop ? ~1'd0 : 1'bz;
	assign #T_TRI  benu = ~afop ? ~1'd0 : 1'bz;
	assign #T_TRI  akaj = ~afop ? ~1'd0 : 1'bz;
	assign #T_TRI  asuz = ~afop ? ~1'd0 : 1'bz;
	assign #T_TRI  ataj = ~afop ? ~1'd0 : 1'bz;
	assign #T_TRI  beda = ~afop ? ~1'd0 : 1'bz;
	assign d[0] = anoc;
	assign d[2] = ajec;
	assign d[6] = arar;
	assign d[4] = benu;
