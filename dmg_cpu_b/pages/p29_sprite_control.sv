...
module sprite_control(
	...
	assign #T_TRIB xele = ~oam_b_cpu_nrd ? ~yceb : 1'bz;
	assign #T_TRIB ypon = ~oam_b_cpu_nrd ? ~zuca : 1'bz;
	assign #T_TRIB xuvo = ~oam_b_cpu_nrd ? ~WONE : 1'bz;
	assign #T_TRIB zysa = ~oam_b_cpu_nrd ? ~zaxe : 1'bz;
	assign #T_TRIB yweg = ~oam_b_cpu_nrd ? ~xafu : 1'bz;
	assign #T_TRIB xabu = ~oam_b_cpu_nrd ? ~yses : 1'bz;
	assign #T_TRIB ytux = ~oam_b_cpu_nrd ? ~zeca : 1'bz;
	assign #T_TRIB yfap = ~oam_b_cpu_nrd ? ~ydyv : 1'bz;
	assign #T_INV  ywok = ~cota;
	assign #T_INV  abon = ~texy;
	assign #T_TRI  fugy = ~abon ? ~(~xegu) : 1'bz;
	assign #T_TRI  gavo = ~abon ? ~(~yjex) : 1'bz;
	assign #T_TRI  wyga = ~abon ? ~(~xyju) : 1'bz;
	assign #T_TRI  wune = ~abon ? ~(~ybog) : 1'bz;
	assign #T_TRI  gotu = ~abon ? ~(~wyso) : 1'bz;
	assign #T_TRI  gegu = ~abon ? ~(~xote) : 1'bz;
	assign #T_TRI  xehe = ~abon ? ~(~yzab) : 1'bz;
	...
	assign #T_ADD  { eruc_c, eruc } = ebos + !xuso + 2'b0;
	...
	assign #T_TRI  baxe = ~abon ? ~cyvu : 1'bz;
	assign #T_TRI  aras = ~abon ? ~bore : 1'bz;
	assign #T_TRI  agag = ~abon ? ~buvy : 1'bz;
	assign #T_TRI  abem = ~abon ? ~xuqu : 1'bz;
	assign #T_TRI  dyso = ~abon ? ~1'b0 : 1'bz;
	assign #T_INV  fufo = ~ff40_d2;
	assign #T_AO   gejy = (~xuso && fufo) || (ff40_d2 && wago);
	assign #T_TRI  famu = ~abon ? ~gejy : 1'bz;
	assign d[1] = xele;
	assign d[2] = ypon;
	assign d[3] = xuvo;
	assign d[4] = zysa;
