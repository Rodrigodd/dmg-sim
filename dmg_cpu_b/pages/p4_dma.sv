...
module dma(
	...
	assign #T_TRI  poly = pusy ? ~(~nafa) : 1'bz;
	assign #T_TRI  pare = pusy ? ~(~nygy) : 1'bz;
	assign #T_TRI  rema = pusy ? ~(~para) : 1'bz;
	assign #T_TRI  rofo = pusy ? ~(~pyne) : 1'bz;
	assign #T_TRI  raly = pusy ? ~(~pula) : 1'bz;
	assign #T_TRI  pane = pusy ? ~(~nydo) : 1'bz;
	assign #T_TRI  resu = pusy ? ~(~poku) : 1'bz;
	assign #T_TRI  nuvy = pusy ? ~(~maru) : 1'bz;
