...
module apu_control(
	...
	assign #T_TRI  atum = !adak ? !(!bedu) : 1'bz;
	assign #T_TRI  bocy = !adak ? !(!cozu) : 1'bz;
	assign #T_TRI  arux = !adak ? !(!bumo) : 1'bz;
	assign #T_TRI  amad = !adak ? !(!byre) : 1'bz;
	assign #T_TRI  axem = !adak ? !(!apos) : 1'bz;
	assign #T_TRI  avud = !adak ? !(!ager) : 1'bz;
	assign #T_TRI  awed = !adak ? !(!byga) : 1'bz;
	assign #T_TRI  akod = !adak ? !(!apeg) : 1'bz;
	assign ncpu_rd = aguz;
	assign d[7]    = atum;
	assign d[6]    = bocy;
	assign d[5]    = arux;
	...
	assign #T_TRI  capu = !gumu ? !(!bogu) : 1'bz;
	assign #T_TRI  caga = !gumu ? !(!bafo) : 1'bz;
	assign #T_TRI  boca = !gumu ? !(!atuf) : 1'bz;
	assign #T_TRI  buzu = !gumu ? !(!anev) : 1'bz;
	assign #T_TRI  cere = !gumu ? !(!bepu) : 1'bz;
	assign #T_TRI  cada = !gumu ? !(!befo) : 1'bz;
	assign #T_TRI  cavu = !gumu ? !(!bume) : 1'bz;
	assign #T_TRI  cudu = !gumu ? !(!bofa) : 1'bz;
