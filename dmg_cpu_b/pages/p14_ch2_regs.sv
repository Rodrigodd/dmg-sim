...
module ch2_regs(
	...
	assign #T_TRI  ceka = ~coro ? ~(~bamy) : 1'bz;
	assign #T_TRI  cecy = ~coro ? ~(~bera) : 1'bz;
	...
	assign #T_TRI  hupe = ~guru ? ~(~gata) : 1'bz;
	assign #T_TRI  gene = ~guru ? ~(~fore) : 1'bz;
	assign #T_TRI  hyry = ~guru ? ~(~gage) : 1'bz;
	assign #T_TRI  horo = ~guru ? ~(~gura) : 1'bz;
	assign #T_TRI  here = ~guru ? ~(~gufe) : 1'bz;
	assign #T_TRI  havu = ~gexa ? ~(~hava) : 1'bz;
	assign #T_TRI  hyre = ~gexa ? ~(~hore) : 1'bz;
	assign #T_TRI  huvu = ~gexa ? ~(~hyfu) : 1'bz;
	assign ff17_d4  = gata;
	assign ff17_d3  = fore;
	...
	assign #T_TRI  fava = ~futy ? ~(~done) : 1'bz;
	assign #T_TRI  fajy = ~futy ? ~(~dynu) : 1'bz;
	assign #T_TRI  fegu = ~futy ? ~(~ezof) : 1'bz;
	assign #T_TRI  fose = ~futy ? ~(~cyvo) : 1'bz;
	assign #T_TRI  gero = ~futy ? ~(~fuxo) : 1'bz;
	assign #T_TRI  gaky = ~futy ? ~(~gano) : 1'bz;
	assign #T_TRI  gadu = ~futy ? ~(~goca) : 1'bz;
	assign #T_TRI  gazo = ~futy ? ~(~gane) : 1'bz;
	...
	assign #T_TRI  jeke = ~hypo ? ~(~hero) : 1'bz;
	assign #T_TRI  jaro = ~hypo ? ~(~hepu) : 1'bz;
	assign #T_TRI  huna = ~hypo ? ~(~hevy) : 1'bz;
	assign gane_nq   = ~gane;
	...
	assign #T_TRI  gojy = ~huma ? ~(~emer) : 1'bz;
	assign ff19_d6  = emer;
