...
module timer(
	...
	assign #T_TRI  supe = sora ? !(!sabo) : 1'bz;
	assign #T_TRI  rote = sora ? !(!samy) : 1'bz;
	assign #T_TRI  ryla = sora ? !(!sopu) : 1'bz;
	...
	assign #T_TRI  soku = teda ? !(!rega) : 1'bz;
	assign #T_TRI  racy = teda ? !(!povy) : 1'bz;
	assign #T_TRI  ravy = teda ? !(!peru) : 1'bz;
	assign #T_TRI  sosy = teda ? !(!rate) : 1'bz;
	assign #T_TRI  somu = teda ? !(!ruby) : 1'bz;
	assign #T_TRI  suro = teda ? !(!rage) : 1'bz;
	assign #T_TRI  rowu = teda ? !(!peda) : 1'bz;
	assign #T_TRI  puso = teda ? !(!nuga) : 1'bz;
	...
	assign #T_TRI  reva = tuby ? !(!peto) : 1'bz;
	assign #T_TRI  nola = tuby ? !(!muru) : 1'bz;
	assign #T_TRI  pyre = tuby ? !(!nyke) : 1'bz;
	assign #T_TRI  sapu = tuby ? !(!seta) : 1'bz;
	assign #T_TRI  sete = tuby ? !(!sabu) : 1'bz;
	assign #T_TRI  supo = tuby ? !(!tyru) : 1'bz;
	assign #T_TRI  sotu = tuby ? !(!sufy) : 1'bz;
	assign #T_TRI  salu = tuby ? !(!tyva) : 1'bz;
