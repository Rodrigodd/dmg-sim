...
module oam(
	...
	assign #T_TRI  wydu = !oam_addr_nrender ? !1 : 1'bz;
	assign #T_TRI  wuwe = !oam_addr_nparse  ? !0 : 1'bz;
	assign #T_TRI  fesa = !oam_addr_ndma    ? !dma_a[1] : 1'bz;
	assign #T_TRI  garo = !oam_addr_ncpu    ? !a[0] : 1'bz;
	assign #T_TRI  geca = !oam_addr_nrender ? !1 : 1'bz;
	assign #T_TRI  gefy = !oam_addr_nparse  ? !0 : 1'bz;
