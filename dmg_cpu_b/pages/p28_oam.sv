...
module oam(
	...
	assign #T_TRI  zaxa = ~azul ? ~d[0] : 1'bz;
	assign #T_TRI  zamy = ~azul ? ~d[0] : 1'bz;
	assign #T_TRI  zaky = ~azul ? ~d[1] : 1'bz;
	assign #T_TRI  zopu = ~azul ? ~d[1] : 1'bz;
	assign #T_TRI  wule = ~azul ? ~d[2] : 1'bz;
	assign #T_TRI  wyky = ~azul ? ~d[2] : 1'bz;
	assign #T_TRI  zozo = ~azul ? ~d[3] : 1'bz;
	assign #T_TRI  zaja = ~azul ? ~d[3] : 1'bz;
	assign #T_TRI  zufo = ~azul ? ~d[4] : 1'bz;
	assign #T_TRI  zuga = ~azul ? ~d[4] : 1'bz;
	assign #T_TRI  zato = ~azul ? ~d[5] : 1'bz;
	assign #T_TRI  zumo = ~azul ? ~d[5] : 1'bz;
	assign #T_TRI  yvuc = ~azul ? ~d[6] : 1'bz;
	assign #T_TRI  xyto = ~azul ? ~d[6] : 1'bz;
	assign #T_TRI  zufe = ~azul ? ~d[7] : 1'bz;
	assign #T_TRI  zyfa = ~azul ? ~d[7] : 1'bz;
	assign #T_TRI  wuzu = ~azar ? ~md[0] : 1'bz;
	assign #T_TRI  wowa = ~azar ? ~md[0] : 1'bz;
	assign #T_TRI  axer = ~azar ? ~md[1] : 1'bz;
	assign #T_TRI  aveb = ~azar ? ~md[1] : 1'bz;
	assign #T_TRI  asox = ~azar ? ~md[2] : 1'bz;
	assign #T_TRI  amuh = ~azar ? ~md[2] : 1'bz;
	assign #T_TRI  cetu = ~azar ? ~md[3] : 1'bz;
	assign #T_TRI  cofo = ~azar ? ~md[3] : 1'bz;
	assign #T_TRI  aryn = ~azar ? ~md[4] : 1'bz;
	assign #T_TRI  azoz = ~azar ? ~md[4] : 1'bz;
	assign #T_TRI  acot = ~azar ? ~md[5] : 1'bz;
	assign #T_TRI  agyk = ~azar ? ~md[5] : 1'bz;
	assign #T_TRI  cuje = ~azar ? ~md[6] : 1'bz;
	assign #T_TRI  buse = ~azar ? ~md[6] : 1'bz;
	assign #T_TRI  ater = ~azar ? ~md[7] : 1'bz;
	assign #T_TRI  anum = ~azar ? ~md[7] : 1'bz;
	...
	assign #T_TRI  foby = ~oam_addr_ncpu    ? ~a[7] : 1'bz;
	assign #T_TRI  fyke = ~oam_addr_nrender ? ~weza : 1'bz;
	assign #T_TRI  goby = ~oam_addr_nparse  ? ~fony : 1'bz;
	assign #T_TRI  fetu = ~oam_addr_ndma    ? ~dma_a[7] : 1'bz;
	assign #T_TRI  waxa = ~oam_addr_ncpu    ? ~a[6] : 1'bz;
	assign #T_TRI  fugu = ~oam_addr_nrender ? ~wuco : 1'bz;
	assign #T_TRI  gama = ~oam_addr_nparse  ? ~faha : 1'bz;
	assign #T_TRI  fydu = ~oam_addr_ndma    ? ~dma_a[6] : 1'bz;
	assign #T_TRI  gera = ~oam_addr_ncpu    ? ~a[5] : 1'bz;
	assign #T_TRI  faco = ~oam_addr_nrender ? ~wyda : 1'bz;
	assign #T_TRI  faku = ~oam_addr_nparse  ? ~elyn : 1'bz;
	assign #T_TRI  edol = ~oam_addr_ndma    ? ~dma_a[5] : 1'bz;
	assign #T_TRI  fevu = ~oam_addr_ncpu    ? ~a[4] : 1'bz;
	assign #T_TRI  faby = ~oam_addr_nrender ? ~zysu : 1'bz;
	assign #T_TRI  futo = ~oam_addr_nparse  ? ~goso : 1'bz;
	assign #T_TRI  elug = ~oam_addr_ndma    ? ~dma_a[4] : 1'bz;
	assign #T_TRI  wape = ~oam_addr_ncpu    ? ~a[3] : 1'bz;
	assign #T_TRI  gyka = ~oam_addr_nrender ? ~wyse : 1'bz;
	assign #T_TRI  gema = ~oam_addr_nparse  ? ~wewy : 1'bz;
	assign #T_TRI  fyky = ~oam_addr_ndma    ? ~dma_a[3] : 1'bz;
	assign #T_TRI  gose = ~oam_addr_ncpu    ? ~a[2] : 1'bz;
	assign #T_TRI  gybu = ~oam_addr_nrender ? ~wuzy : 1'bz;
	assign #T_TRI  guse = ~oam_addr_nparse  ? ~yfel : 1'bz;
	assign #T_TRI  fago = ~oam_addr_ndma    ? ~dma_a[2] : 1'bz;
	assign #T_TRI  wacu = ~oam_addr_ncpu    ? ~a[1] : 1'bz;
	assign #T_TRI  wydu = ~oam_addr_nrender ? ~1'b1 : 1'bz;
	assign #T_TRI  wuwe = ~oam_addr_nparse  ? ~1'b0 : 1'bz;
	assign #T_TRI  fesa = ~oam_addr_ndma    ? ~dma_a[1] : 1'bz;
	assign #T_TRI  garo = ~oam_addr_ncpu    ? ~a[0] : 1'bz;
	assign #T_TRI  geca = ~oam_addr_nrender ? ~1'b1 : 1'bz;
	assign #T_TRI  gefy = ~oam_addr_nparse  ? ~1'b0 : 1'bz;
	assign #T_TRI  fodo = ~oam_addr_ndma    ? ~dma_a[0] : 1'bz;
