...
module ext_cpu_busses(
	...
	assign #T_TRIB syzu = ~ryca ? raza : 1'bz;
	...
	assign #T_TRIB anar = ~net01 ? base : 1'bz;
	assign #T_TRIB azuv = ~net01 ? afec : 1'bz;
	assign #T_TRIB akan = ~net01 ? buxu : 1'bz;
	assign #T_TRIB byxe = ~net01 ? camu : 1'bz;
	assign #T_TRIB byne = ~net01 ? cygu : 1'bz;
	assign #T_TRIB byna = ~net01 ? cogo : 1'bz;
	assign #T_TRIB kejo = ~net01 ? kova : 1'bz;
	assign a[3] = anar;
	assign a[4] = azuv;
	assign a[2] = akan;
	assign a[1] = byxe;
	...
	assign #T_TRIB lyna = ~net01 ? lahe : 1'bz;
	assign #T_TRIB lefy = ~net01 ? lura : 1'bz;
	assign #T_TRIB lofa = ~net01 ? mujy : 1'bz;
	assign #T_TRIB nefe = ~net01 ? pevo : 1'bz;
	assign #T_TRIB lora = ~net01 ? mady : 1'bz;
	assign #T_TRIB mapu = ~net01 ? nena : 1'bz;
	assign #T_TRIB rala = ~net01 ? sura : 1'bz;
	assign #T_TRIB ajov = ~net01 ? abup : 1'bz;
	assign a[12] = lyna;
	assign a[13] = lefy;
	assign a[8]  = lofa;
	assign a[14] = nefe;
