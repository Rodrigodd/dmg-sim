...
module background(
	...
	assign #T_TRI  asum = !beje ? !xuha : 1'bz;
	assign #T_TRI  evad = !beje ? !fafo : 1'bz;
	assign #T_TRI  dahu = !beje ? !emux : 1'bz;
	assign #T_TRI  dode = !beje ? !ecab : 1'bz;
	assign #T_TRI  duho = !bafy ? !etam : 1'bz;
	assign #T_TRI  CASE = !bafy ? !doto : 1'bz;
	assign #T_TRI  cypo = !bafy ? !daba : 1'bz;
	assign #T_TRI  ceta = !bafy ? !efyk : 1'bz;
	assign #T_TRI  dafe = !bafy ? !ejok : 1'bz;
	...
	assign #T_TRI  amuv = !bafy ? !ff40_d3 : 1'bz;
	assign #T_TRI  coxo = !bafy ? !1'b1 : 1'bz;
	assign #T_TRI  cove = !bafy ? !1'b1 : 1'bz;
	assign #T_TRI  axep = !bafy ? !babe : 1'bz;
	assign #T_TRI  afeb = !bafy ? !abod : 1'bz;
	assign #T_TRI  alel = !bafy ? !bewy : 1'bz;
	assign #T_TRI  coly = !bafy ? !byca : 1'bz;
	assign #T_TRI  ajan = !bafy ? !acul : 1'bz;
	assign nma[0]  = asum;
	assign nma[1]  = evad;
	assign nma[2]  = dahu;
	assign nma[3]  = dode;
