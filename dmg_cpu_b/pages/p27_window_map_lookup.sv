...
module window_map_lookup(
	...
	assign #T_TRI  vevy = ~wuko ? ~ff40_d6 : 1'bz;
	assign #T_TRI  vogu = ~wuko ? ~1'b1 : 1'bz;
	assign #T_TRI  veza = ~wuko ? ~1'b1 : 1'bz;
	assign #T_TRI  vyto = ~wuko ? ~tufu : 1'bz;
	assign #T_TRI  veha = ~wuko ? ~taxa : 1'bz;
	assign #T_TRI  vace = ~wuko ? ~tozo : 1'bz;
	assign #T_TRI  vovo = ~wuko ? ~tate : 1'bz;
	assign #T_TRI  vulo = ~wuko ? ~teke : 1'bz;
	assign #T_TRI  xeja = ~wuko ? ~wyka : 1'bz;
	assign #T_TRI  xamo = ~wuko ? ~wody : 1'bz;
	assign #T_TRI  xahe = ~wuko ? ~wobo : 1'bz;
	assign #T_TRI  xulo = ~wuko ? ~wyko : 1'bz;
	assign #T_TRI  wuju = ~wuko ? ~xolo : 1'bz;
	assign nma[10] = vevy;
	assign nma[12] = vogu;
	assign nma[11] = veza;
	assign nma[5]  = vyto;
