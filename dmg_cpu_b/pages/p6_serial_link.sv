...
module serial_link(
	...
	assign #T_TRI  eluv = ucom ? !(!etaf) : 1'bz;
	assign #T_TRI  core = ucom ? !(!culy) : 1'bz;
	...
	assign #T_TRI  cugy = ufeg ? !(!cuba) : 1'bz;
	assign #T_TRI  dude = ufeg ? !(!degu) : 1'bz;
	assign #T_TRI  detu = ufeg ? !(!dyra) : 1'bz;
	assign #T_TRI  daso = ufeg ? !(!dojo) : 1'bz;
	assign #T_TRI  dame = ufeg ? !(!dovu) : 1'bz;
	assign #T_TRI  evok = ufeg ? !(!ejab) : 1'bz;
	assign #T_TRI  efab = ufeg ? !(!erod) : 1'bz;
	assign #T_TRI  etak = ufeg ? !(!eder) : 1'bz;
	assign a00_07  = sare;
	assign d[0]    = cugy;
	assign d[1]    = dude;
	assign d[2]    = detu;
