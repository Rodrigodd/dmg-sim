...
module video_control(
	...
	assign #T_TRI  puzo = !vave ? !(!roxe) : 1'bz;
	assign #T_TRI  sasy = !vave ? !(!refe) : 1'bz;
	assign #T_TRI  pofo = !vave ? !(!rufo) : 1'bz;
	assign #T_TRI  pote = !vave ? !(!rugu) : 1'bz;
	assign #T_TRI  teby = tobe ? !sadu : 1'bz;
	assign #T_TRI  wuga = tobe ? !xaty : 1'bz;
	assign #T_OR   pago = nreset9 || ryju;
	assign #T_TRI  sego = tobe ? !nrupo : 1'bz;
	assign nnype = !nype;
	assign int_vbl     = paru;
	assign int_oam     = tapa;
	assign int_hbl     = taru;
